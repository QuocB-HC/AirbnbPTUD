...
import { addNewFeature } from "../../../api/feature.api";
...
export default function AddFeatureModal({ onCloseModal }: Props) {
  ...
  const handleConfirm = async () => {
    ...
    await addNewFeature(newFeature);
    Alert.alert("Thông báo", "Đã lưu Feature thành công");
    onCloseModal(false);
  };
